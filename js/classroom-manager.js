        ...
        grid.innerHTML = classes.map(recordedClass => {
            ...
            return `
                <div class="recorded-class-card" style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.95), rgba(30, 41, 59, 0.95)); border-radius: 16px; padding: 0; border: 2px solid rgba(251, 191, 36, 0.2); transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3);">
                    ...
                    <!-- Player de Vídeo -->
                    <div style="margin: 0; border-radius: 0 0 16px 16px; overflow: hidden; background: #000; aspect-ratio: 16/9; position: relative;">
                        ...
                        ` : `
                            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; color: #94a3b8; padding: 40px; text-align: center;">
                                <i class="fas fa-video" style="font-size: 3rem; margin-bottom: 15px; color: #3b82f6; opacity: 0.7;"></i>
                                <a href="${escapeHtml(recordedClass.videoUrl)}" target="_blank" style="color: #3b82f6; text-decoration: none; font-weight: 600; font-size: 1.1rem; padding: 12px 24px; background: rgba(59, 130, 246, 0.2); border-radius: 8px; border: 2px solid rgba(59, 130, 246, 0.4); transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 8px;" onmouseover="this.style.background='rgba(59, 130, 246, 0.3)'; this.style.transform='translateY(-2px)'" onmouseout="this.style.background='rgba(59, 130, 246, 0.2)'; this.style.transform='translateY(0)'">
